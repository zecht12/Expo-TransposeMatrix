...
export default function App() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ width: 300, height: 300, backgroundColor: '#10B981', position: 'absolute', borderRadius: 150, bottom: -28, right: -48 }}></View>
<View style={{ width: 300, height: 300, backgroundColor: '#B45309', position: 'absolute', borderRadius: 150, bottom: -12, left: 28 }}></View>
    </SafeAreaView>
  );
}
